...
import "./MyTokenACF46F92.sol";

contract MyTokenACF46F92PreSale {
    MyTokenACF46F92 public token;
    ...
    function MyTokenACF46F92PreSale(
        MyTokenACF46F92 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenACF46F92(_token);
